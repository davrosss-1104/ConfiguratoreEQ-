  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const body: any = {
        ...
        product_template_id: editingSezione.product_template_id || null,
      };
    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-4 text-sm">
        ...
        <Badge variant="outline" className="gap-1 text-purple-700 border-purple-300">
          <Link2 className="h-3 w-3" /> {sezioni.filter(s => s.product_template_id).length} con prodotto
        </Badge>
      </div>
                      ...
                      <div className="flex items-center gap-2 mt-1.5">
                        {sezione.prodotto ? (
                          <Badge variant="outline" className="text-xs gap-1 text-blue-700 border-blue-200 bg-blue-50">
                            ...
                            {sezione.prodotto.categoria} › {sezione.prodotto.nome_display || sezione.prodotto.sottocategoria}
                          </Badge>
                        ) : (
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <Label className="text-sm font-medium flex items-center gap-2">
                    ...
                    Prodotto associato (secondo livello)
                  </Label>
                  <Select
                    value={editingSezione.product_template_id?.toString() || 'none'}
                    onValueChange={(v) => setEditingSezione({
                      ...editingSezione,
                      product_template_id: v === 'none' ? null : parseInt(v)
                    })}
                  >
                    <SelectTrigger className="mt-1">
                      <SelectValue placeholder="Nessun prodotto associato" />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="none">
                        <span className="text-gray-400">— Nessun prodotto —</span>
                      </SelectItem>
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    Collegando un prodotto, questa sezione apparirà solo per quel tipo di preventivo
                  </p>
                </div>
          ...
          {selectedSezione && !editingSezione && (
            <>
              ...
              <Card>
                ...
                <CardContent>
                  {/* Prodotto associato */}
                  {selectedSezione.prodotto && (
                    <div className="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                      <div className="flex items-center gap-2 text-sm">
                        <Package className="h-4 w-4 text-blue-600" />
                        <span className="font-medium text-blue-800">
                          Prodotto: {selectedSezione.prodotto.categoria} › {selectedSezione.prodotto.nome_display || selectedSezione.prodotto.sottocategoria}
                        </span>
                      </div>
                    </div>
                  )}
