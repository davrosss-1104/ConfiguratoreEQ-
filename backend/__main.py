        ...
        if all_conditions_met:
            ...
            for mat in rule.get("materials", []):
                ...
                if not existing:
                    ...
                    if articolo:
                        # Usa prezzo_listino dall'articolo
                        prezzo_unitario = float(articolo.prezzo_listino or 0)
                        descrizione = articolo.descrizione
                        lead_time_produzione = getattr(articolo, 'lead_time_produzione', 0) or 0
                        lead_time_acquisto = getattr(articolo, 'lead_time_acquisto', 0) or 0
                        ...
                        lead_time_produzione = 0
                        lead_time_acquisto = 0
